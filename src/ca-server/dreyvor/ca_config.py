...
ROOT_CERT_PATH = ROOT_FOLDER + 'root.crt'  # file, DO NOT MODIFY
...
INTERMEDIATE_TLS_CERT_PATH = INTERMEDIATE_TLS_FOLDER + TLS_FOLDER_NAME + INTERMEDIATE_SUFFIX_CERT_NAME  # file, DO NOT MODIFY
INTERMEDIATE_TLS_PRIVKEY_PATH = ROOT_FOLDER + PRIVKEYS_FOLDER_NAME + TLS_FOLDER_NAME + INTERMEDIATE_SUFFIX_PRIVKEY_NAME  # file, DO NOT MODIFY
